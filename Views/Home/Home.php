...
<head>
    ...
    <title>Home SPA Crud</title>
    <link rel="stylesheet" href="./css/styleHome.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.1/css/all.min.css" integrity="sha512-5Hs3dF2AEPkpNAR7UiOHba+lRSJNeM2ECkwxUIxC1Q/FLycGTbNapWXB4tP889k5T5Ju8fs4b1P5z/iB4nMfSQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
<body>
<main>
  <div class="card" onclick="Navigator('spa')">
  ...
  <div class="card" style="--active-color: #e0f2fe" onclick="Navigator('report')">
...
<script>
    function Navigator(case_match){
        switch (case_match) {
            case 'spa':
                location.href='/crud_basado_clases/Views/spa_crud.php'
                break;
        
            case 'report':
                location.href='/crud_basado_clases/Views/reports.php'
                break;
